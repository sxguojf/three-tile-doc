...
`,C=JSON.parse('{"title":"2. TileMap 创建","description":"","frontmatter":{},"headers":[],"relativePath":"2.base/02.mapCreate/index.md","filePath":"2.base/02.mapCreate/index.md","lastUpdated":1764224771000}'),y={name:"2.base/02.mapCreate/index.md"},D=Object.assign(y,{setup(u){const n=t(!0);return(b,s)=>{const l=p("ClientOnly");return r(),h("div",null,[s[1]||(s[1]=e(`<h1 id="_2-tilemap-创建" tabindex="-1">2. TileMap 创建 <a class="header-anchor" href="#_2-tilemap-创建" aria-label="Permalink to &quot;2. TileMap 创建&quot;">​</a></h1><p>瓦片地图类 <code>TileMap</code> 是地图的核心类，它继承于 <code>threejs</code> 的 <code>Object3D</code> ，地图的绝大数操作均可通过对 <code>TileMap</code> 类完成。创建一个地图实例，并将它加入三维场景：</p><p>示例：</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 创建地图</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">viewer.controls.target.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">copy</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(centerPostion);</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div>`,11))])}}});export{C as __pageData,D as default};
