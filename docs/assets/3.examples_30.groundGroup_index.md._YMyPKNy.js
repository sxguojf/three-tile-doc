import{p as e,C as p,c as l,o as h,j as r,a4 as k,G as i,a2 as o,a as d,a5 as E,k as n,w as c}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as g,VitepressDemoBox as y}from"vitepress-demo-plugin";const u=`<style>\r
    html,\r
    body {\r
        color: #ddd;\r
...
<\/script>\r
`,B=JSON.parse('{"title":"30. 贴地模型组","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/30.groundGroup/index.md","filePath":"3.examples/30.groundGroup/index.md","lastUpdated":1790261744000}'),m={name:"3.examples/30.groundGroup/index.md"},v=Object.assign(m,{setup(F){const a=e(!0);return(b,s)=>{const t=p("ClientOnly");return h(),l("div",null,[s[1]||(s[1]=r("h1",{id:"_30-贴地模型组",tabindex:"-1"},[d("30. 贴地模型组 "),r("a",{class:"header-anchor",href:"#_30-贴地模型组","aria-label":'Permalink to "30. 贴地模型组"'},"​")],-1)),k(i(n(g),null,null,512),[[E,a.value]]),i(t,null,{default:c(()=>[i(n(y),{title:"Example",description:"随机在地面添加一批树",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=o(`<p>建筑物、树木等模型要放在地面上，需要传入模型所在地面海拔高度才能准确贴地，但不同层级地形瓦片的几何误差不同，同一位置的高度在不同层级高度不同，所以需要根据模型所在位置动态调整贴地高度，这个计算比较繁琐。为了简化贴地操作，three-tile 提供 GroundGroup 插件，它继承 threejs 的 Group 对象，只要将模型、精灵等加入 GroundGroup，就能够自动贴地。上面示例中，你可以看到不同缩放级别下，同样位置的树木的海拔高度不同。</p><p>下面的代码以 sprite 方式，随机向地面添加 500 棵树：</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 创建贴地模型组</span></span>
