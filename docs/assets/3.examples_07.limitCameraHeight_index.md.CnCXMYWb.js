import{p as l,C as s,c as o,o as p,j as t,a4 as h,G as i,a2 as d,a as c,a5 as m,k as n,w as u}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as g,VitepressDemoBox as k}from"vitepress-demo-plugin";const b="/three-tile-doc/assets/image-1.q_U1_vxc.png",v=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    function fly() {\r
        ...
        const centerPosition = map.geo2world(new THREE.Vector3(86.95, 27.98, 0));\r
        // 摄像机经纬度高度（m）转为世界坐标\r
...
<\/script>\r
`,C=JSON.parse('{"title":"7. 防止摄像机碰撞地面","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/07.limitCameraHeight/index.md","filePath":"3.examples/07.limitCameraHeight/index.md","lastUpdated":1790261744000}'),_={name:"3.examples/07.limitCameraHeight/index.md"},P=Object.assign(_,{setup(E){const r=l(!0);return(x,e)=>{const a=s("ClientOnly");return p(),o("div",null,[e[1]||(e[1]=t("h1",{id:"_7-防止摄像机碰撞地面",tabindex:"-1"},[c("7. 防止摄像机碰撞地面 "),t("a",{class:"header-anchor",href:"#_7-防止摄像机碰撞地面","aria-label":'Permalink to "7. 防止摄像机碰撞地面"'},"​")],-1)),h(i(n(g),null,null,512),[[m,r.value]]),i(a,null,{default:u(()=>[i(n(k),{title:"example",description:"防止摄像机进入地下，接近地面会反弹",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{r.value=!1}),htmlCode:n(v)},null,8,["htmlCode"])]),_:1}),e[2]||(e[2]=d(`<div class="tip custom-block"><p class="custom-block-title">此功能已提供内置插件，直接调用即可。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 防止摄像机进入地下</span></span>
