import{p as i,C as l,c as s,o as d,j as o,a4 as c,G as r,a as h,a5 as m,k as n,w as p}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as u,VitepressDemoBox as w}from"vitepress-demo-plugin";const g=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    ...
    const createViewer = () => {\r
        ...
        // viewer.renderer.shadowMap.type = THREE.VSMShadowMap;\r
        return viewer;\r
    };\r
\r
    //==============================================================\r
...
\r
    const createLight = () => {\r
        ...
        light.position.set(centerPosition.x + 3000, centerPosition.y + 5000, centerPosition.z + 3000);\r
...
\r
        ...
        model.traverse((child) => {\r
            if (child.isMesh) {\r
                ...
                child.material.roughness = 0.5;\r
...
<div id="model-loading">loading...</div>\r
`,L=JSON.parse('{"title":"38. 建筑物白模","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/38.addWhiteModel/index.md","filePath":"3.examples/38.addWhiteModel/index.md","lastUpdated":1773556276000}'),v={name:"3.examples/38.addWhiteModel/index.md"},C=Object.assign(v,{setup(x){const t=i(!0);return(f,e)=>{const a=l("ClientOnly");return d(),s("div",null,[e[1]||(e[1]=o("h1",{id:"_38-建筑物白模",tabindex:"-1"},[h("38. 建筑物白模 "),o("a",{class:"header-anchor",href:"#_38-建筑物白模","aria-label":'Permalink to "38. 建筑物白模"'},"​")],-1)),c(r(n(u),null,null,512),[[m,t.value]]),r(a,null,{default:p(()=>[r(n(w),{title:"example",description:"添加建筑物白模",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{t.value=!1}),htmlCode:n(g)},null,8,["htmlCode"])]),_:1})])}}});export{L as __pageData,C as default};
