const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Atmosphere.CZkW9GEC.js","assets/chunks/index.CqI7X3xo.js","assets/chunks/lil-gui.module.min.Vka56b52.js","assets/chunks/style.Ddmk4huO.js","assets/chunks/framework.xbTv8SNN.js","assets/chunks/useState.EiXjSKHF.js"])))=>i.map(i=>d[i]);
import{p,D as l,v as d,V as c,C as u,c as f,o as g,j as o,a4 as v,G as n,a as h,a5 as y,k as e,w as i,a6 as C}from"./chunks/framework.xbTv8SNN.js";import{R as S,k as w}from"./chunks/index.T3-yMMRo.js";const k=`<template>\r
...
\r
        // 跳转\r
        goto(viewer, map, new Vector3(109, 34, 500), new Vector3(109.1, 34.1, 3000));\r
\r
        // 防止摄像机穿过地面\r
...
\r
    ...
    const defaultParams = {\r
        // 云\r
        uTime: 0.0,\r
        mult: 2.0, // 频率，控制云的局部变化\r
        weaken: 0.5, // 采样衰减因子，控制云量\r
        THICKNESS: 80, // 云厚度\r
...
\r
    const sun = viewer.dirLight.position; // new Vector3(); //太阳位置\r
\r
    const resetParams = () => {\r
...
\r
        ...
        skyUniforms["Intensity"].value = params.skyIntensity;\r
\r
...
\r
        ...
        folderSky\r
            ...
            .listen();\r
\r
        folderSky.add(params, "skyIntensity", 0, 1, 0.01).onChange(update).name("天空亮度").listen();\r
\r
...
\r
        ...
        folderCloud.add(params, "mult", 0, 3, 0.01).onChange(update).name("频率").listen();\r
        ...
        folderCloud.add(params, "N_MARCH_STEPS", 0, 5, 1).onChange(update).name("采样次数").listen();\r
...
\r
    ...
    const overcast = () => {\r
        resetParams();\r
        params.fogColor.set(0);\r
        params.fogFactor = 0.5;\r
        params.elevation = 50;\r
        params.turbidity = 20;\r
        params.rayleigh = 0.3;\r
...
\r
    ...
    const fog = () => {\r
        resetParams();\r
        params.fogFactor = 4;\r
        params.turbidity = 20;\r
        params.rayleigh = 2.5;\r
        params.weaken = 0.8;\r
        params.fogColor.set(0xcccccc);\r
        params.elevation = 50;\r
...
\r
    ...
    const night1 = () => {\r
        resetParams();\r
        params.elevation = 10;\r
        params.sunSize = 2;\r
        params.turbidity = 10;\r
        params.rayleigh = 0.6;\r
        params.mieCoefficient = 0.09;\r
        params.mieDirectionalG = 0.999999;\r
        params.THICKNESS = 30;\r
        params.ABSORPTION = 0.8;\r
        params.weaken = 0.5;\r
        params.coverage = 0.4;\r
        params.skylineF = 0.2;\r
        params.fogFactor = 2;\r
        params.fogColor.set(0);\r
        params.ambLight = 0.5;\r
        params.dirLight = 0.5;\r
        update();\r
...
\r
    ...
    const night2 = () => {\r
        ...
        // params.turbidity = 1;\r
        // params.rayleigh = 0;\r
        // params.mieCoefficient = 0.01;\r
        // params.mieDirectionalG = 0.999;\r
        // params.weaken = 0.8;\r
        // params.THICKNESS = 50;\r
        // params.ABSORPTION = 0.3;\r
        // params.coverage = 1;\r
        // params.curve = 1;\r
        params.elevation = 22;\r
        params.mieCoefficient = 0.1;\r
        params.mieDirectionalG = 0.999;\r
        params.skyIntensity = 0;\r
        params.fogFactor = 2;\r
        params.fogColor.set(0x111111);\r
        params.ambLight = 0.5;\r
        params.dirLight = 0.0;\r
        update();\r
    };\r
<\/script>\r
`,x=JSON.parse('{"title":"6. 大气环境模拟","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/06.atmosphere/index.md","filePath":"4.application/06.atmosphere/index.md","lastUpdated":1766327261000}'),b={name:"4.application/06.atmosphere/index.md"},M=Object.assign(b,{setup(T){const t=p(!0),a=l();return d(async()=>{a.value=(await c(async()=>{const{default:s}=await import("./chunks/Atmosphere.CZkW9GEC.js");return{default:s}},__vite__mapDeps([0,1,2,3,4,5]))).default}),(s,r)=>{const m=u("ClientOnly");return g(),f("div",null,[r[1]||(r[1]=o("h1",{id:"_6-大气环境模拟",tabindex:"-1"},[h("6. 大气环境模拟 "),o("a",{class:"header-anchor",href:"#_6-大气环境模拟","aria-label":'Permalink to "6. 大气环境模拟"'},"​")],-1)),v(n(e(S),null,null,512),[[y,t.value]]),n(m,null,{default:i(()=>[n(e(w),{title:"vue演示",description:"综合环境，包括天空、云层、太阳、雾等",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:r[0]||(r[0]=()=>{t.value=!1}),vueCode:e(k)},C({_:2},[a.value?{name:"vue",fn:i(()=>[n(e(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{x as __pageData,M as default};
