import{p as e,C as t,c as r,o as h,j as l,a4 as k,G as i,a2 as d,a as E,a5 as c,k as n,w as o}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as g,VitepressDemoBox as y}from"vitepress-demo-plugin";const b=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    ...
    const centerPosition = map.geo2world(new THREE.Vector3(109, 35, 0));\r
    // 摄像机经纬度高度（m）转为世界坐标\r
...
<\/script>\r
`,B=JSON.parse('{"title":"14. 添加矢量瓦片","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/14.addMVT/index.md","filePath":"3.examples/14.addMVT/index.md","lastUpdated":1773556276000}'),u={name:"3.examples/14.addMVT/index.md"},f=Object.assign(u,{setup(m){const a=e(!0);return(F,s)=>{const p=t("ClientOnly");return h(),r("div",null,[s[1]||(s[1]=l("h1",{id:"_14-添加矢量瓦片",tabindex:"-1"},[E("14. 添加矢量瓦片 "),l("a",{class:"header-anchor",href:"#_14-添加矢量瓦片","aria-label":'Permalink to "14. 添加矢量瓦片"'},"​")],-1)),k(i(n(g),null,null,512),[[c,a.value]]),i(p,null,{default:o(()=>[i(n(y),{title:"example",description:"加载矢量数据，数据来自： https://api.maptiler.com/tiles",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(b)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=d(`<div class="danger custom-block"><p class="custom-block-title">注意</p><p>本示例矢量瓦片数据来自 (<a href="https://api.maptiler.com/tiles" target="_blank" rel="noreferrer">https://api.maptiler.com/tiles</a>) , 地图数据不代表本人观点</p></div><p>对矢量瓦片支持，使用 three-tile 的 mvt 加载器插件完成。支持 MapBox 的 pbf 格式矢量瓦片。</p><h2 id="_1-使用方法" tabindex="-1">1. 使用方法 <a class="header-anchor" href="#_1-使用方法" aria-label="Permalink to &quot;1. 使用方法&quot;">​</a></h2><p>使用方法与加载 <code>geojson</code> 数据类似</p><ol><li>注册 <code>mvt</code> 加载器：<code>tt.registerImgLoader(new plugin.MVTLoader());</code></li><li>声明 矢量瓦片 数据源</li><li>设置 <code>TileMap.imgSource</code> 为 <code>mvt</code> 数据源</li></ol><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. 注册矢量瓦片MVT加载器</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br></div></div><h2 id="_3-注意事项" tabindex="-1">3. 注意事项 <a class="header-anchor" href="#_3-注意事项" aria-label="Permalink to &quot;3. 注意事项&quot;">​</a></h2><ol><li>不兼容 mapbox 的样式配置，mapbox 的瓦片样式配置实在太复杂，无法兼容。</li><li>国内找不到稳定的矢量瓦片数据源，只能用老外的，生产环境不能用它，尽量自己切瓦片。</li><li>矢量瓦片渲染代码不太成熟，仅实现基本功能。</li></ol>`,10))])}}});export{B as __pageData,f as default};
