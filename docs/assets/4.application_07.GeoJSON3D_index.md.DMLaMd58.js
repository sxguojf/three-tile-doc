const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/GeoJSON3D.C4Xx2Lkh.js","assets/chunks/index.DsnQMYJ2.js","assets/chunks/lil-gui.module.min.Vka56b52.js","assets/chunks/style.C0FUdygw.js","assets/chunks/framework.xbTv8SNN.js","assets/chunks/useState.EiXjSKHF.js","assets/chunks/useSky.3BKOAXo9.js","assets/chunks/BufferGeometryUtils.DCmjMfYP.js"])))=>i.map(i=>d[i]);
import{p as c,D as d,v as m,V as u,C as p,c as g,o as b,j as i,a4 as v,G as n,a as f,a5 as w,k as r,w as s,a6 as h}from"./chunks/framework.xbTv8SNN.js";import{I as x,$ as y}from"./chunks/index.Dw17pxVn.js";const M=`<template>\r
...
<script setup lang="ts">\r
    ...
    import { GLTFExporter, TransformControls } from "three/examples/jsm/Addons.js";\r
...
\r
    const bbox: [number, number, number, number] = [108.92, 34.2524, 108.9675, 34.2783];\r
    // const bbox: [number, number, number, number] = [126.6, 45.698, 126.66, 45.75];\r
\r
    //=================================================================================\r
    onMounted(() => {\r
...
\r
    const addFence = (bbox: [number, number, number, number]) => {\r
        ...
        const fenceMaterial = new MeshStandardMaterial({\r
            color: 0xff0000,\r
            transparent: true,\r
            wireframe: false,\r
            side: DoubleSide,\r
        });\r
        const fenceGeometry = new BoxGeometry();\r
        const fence = new Mesh(fenceGeometry, [fenceMaterial, fenceMaterial, fenceMaterial, fenceMaterial]);\r
        fence.name = "fence";\r
        // const fence = new Box3Helper(box);\r
        fence.scale.set(box.max.x - box.min.x, box.max.y - box.min.y, box.max.z - box.min.z);\r
        box.getCenter(fence.position);\r
        map.add(fence);\r
\r
        const transform = new TransformControls(viewer.camera, viewer.renderer.domElement);\r
\r
        transform.showY = false;\r
        transform.attach(fence);\r
        const transGizmo = transform.getHelper();\r
        transGizmo.name = "transformGizmo";\r
        viewer.scene.add(transGizmo);\r
        transform.addEventListener("dragging-changed", function (event) {\r
            viewer.controls.enabled = !event.value;\r
        });\r
\r
        const scale = new TransformControls(viewer.camera, viewer.renderer.domElement);\r
        scale.showZ = false;\r
        scale.setSize(0.5);\r
        scale.setMode("scale");\r
        scale.attach(fence);\r
        const scaleGizmo = scale.getHelper();\r
        viewer.scene.add(scaleGizmo);\r
        scaleGizmo.name = "scaleGizmo";\r
        scale.addEventListener("dragging-changed", function (event) {\r
            viewer.controls.enabled = !event.value;\r
        });\r
\r
        vm.showFence(false);\r
    };\r
\r
    const vm = {\r
        // 导出glb\r
...
\r
        fenceVisible: false,\r
        showFence: (value: boolean) => {\r
            const fenceMesh = map.getObjectByName("fence") as Mesh;\r
            fenceMesh.visible = value;\r
            const transformGizmo = viewer.scene.getObjectByName("transformGizmo") as Mesh;\r
            transformGizmo.visible = value;\r
            const scaleGizmo = viewer.scene.getObjectByName("scaleGizmo") as Mesh;\r
            scaleGizmo.visible = value;\r
        },\r
    };\r
\r
    const initGUI = () => {\r
...
\r
        const material = buildingMesh.material as MeshStandardMaterial;\r
        gui.add(buildingMesh, "visible").name("建筑物显示/隐藏");\r
        ...
        gui.add(buildingMesh.scale, "z", 1, 10).name("建筑物拉伸");\r
\r
        gui.add(vm, "fenceVisible").name("围栏显示/隐藏").onChange(vm.showFence);\r
\r
        gui.add(vm, "exportBuilding").name("导出建筑模型");\r
    };\r
<\/script>\r
`,S=JSON.parse('{"title":"7. 三维建筑物","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/07.GeoJSON3D/index.md","filePath":"4.application/07.GeoJSON3D/index.md","lastUpdated":1767330093000}'),G={name:"4.application/07.GeoJSON3D/index.md"},B=Object.assign(G,{setup(L){const a=c(!0),t=d();return m(async()=>{t.value=(await u(async()=>{const{default:o}=await import("./chunks/GeoJSON3D.C4Xx2Lkh.js");return{default:o}},__vite__mapDeps([0,1,2,3,4,5,6,7]))).default}),(o,e)=>{const l=p("ClientOnly");return b(),g("div",null,[e[1]||(e[1]=i("h1",{id:"_7-三维建筑物",tabindex:"-1"},[f("7. 三维建筑物 "),i("a",{class:"header-anchor",href:"#_7-三维建筑物","aria-label":'Permalink to "7. 三维建筑物"'},"​")],-1)),v(n(r(x),null,null,512),[[w,a.value]]),n(l,null,{default:s(()=>[n(r(y),{title:"vue演示",description:"从（https://tubvsig-so2sat-vm1.srv.mwn.de/） 提供的WFS服务，加载指定经纬度范围的GeoJSON数据，生成建筑物模型",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{a.value=!1}),vueCode:r(M)},h({_:2},[t.value?{name:"vue",fn:s(()=>[n(r(t))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{S as __pageData,B as default};
