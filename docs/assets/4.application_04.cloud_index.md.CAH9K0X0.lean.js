const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Cloud.Bh1F10LC.js","assets/chunks/framework.xbTv8SNN.js","assets/chunks/index.DsnQMYJ2.js","assets/chunks/style.C0FUdygw.js"])))=>i.map(i=>d[i]);
import{p as c,D as d,v as p,V as m,C as u,c as v,o as w,j as o,a4 as f,G as r,a as h,a5 as x,k as n,w as s,a6 as g}from"./chunks/framework.xbTv8SNN.js";import{I as b,$ as M}from"./chunks/index.Dw17pxVn.js";const _=`<template>\r
...
\r
            <div class="scale">\r
                ...
                <input\r
                    ...
                    step="0.1"\r
                    class="scale"\r
                    v-model="cloudMesh.displacementScale"\r
                />\r
            </div>\r
            <div class="scale">\r
                <label for="bias">抬升</label>\r
                <input\r
                    type="range"\r
                    id="bias"\r
                    min="0"\r
                    ...
                    step="0.1"\r
                    class="scale"\r
                    v-model="cloudMesh.displacementBias"\r
                />\r
            </div>\r
        </div>\r
        <!-- 指南针 -->\r
...
\r
    ...
    const createViewer = () => {\r
        ...
        viewer.scene.background = new Color(0x333333);\r
...
\r
        // 添加辅助线框\r
        map.add(new BoxHelper(cloudMesh, 0xff0000));\r
\r
        // 限制地图缩放和移动范围\r
...
`,k=JSON.parse('{"title":"4. 伪三维卫星云图","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/04.cloud/index.md","filePath":"4.application/04.cloud/index.md","lastUpdated":1765361805000}'),y={name:"4.application/04.cloud/index.md"},B=Object.assign(y,{setup(V){const t=c(!0),a=d();return p(async()=>{a.value=(await m(async()=>{const{default:l}=await import("./chunks/Cloud.Bh1F10LC.js");return{default:l}},__vite__mapDeps([0,1,2,3]))).default}),(l,e)=>{const i=u("ClientOnly");return w(),v("div",null,[e[1]||(e[1]=o("h1",{id:"_4-伪三维卫星云图",tabindex:"-1"},[h("4. 伪三维卫星云图 "),o("a",{class:"header-anchor",href:"#_4-伪三维卫星云图","aria-label":'Permalink to "4. 伪三维卫星云图"'},"​")],-1)),f(r(n(b),null,null,512),[[x,t.value]]),r(i,null,{default:s(()=>[r(n(M),{title:"vue演示",description:"伪三维卫星云图",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{t.value=!1}),vueCode:n(_)},g({_:2},[a.value?{name:"vue",fn:s(()=>[r(n(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[2]||(e[2]=o("p",null,"常用的卫星云是红外云图，它是一张二维灰度图片，像素值代表云顶亮温，亮温又与云顶高度相关，有了每个点的高度就可以模拟云的三维效果。",-1))])}}});export{k as __pageData,B as default};
