import{p as r,C as l,c as p,o as h,j as t,a4 as k,G as i,a2 as o,a as d,a5 as E,k as n,w as c}from"./chunks/framework.BZ48x_LH.js";import{R as g,k as m}from"./chunks/index.DCj37L2o.js";const y=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
...
\r
    <body>\r
        ...
        <button class="show-position" onclick="showPosition()">显示模型位置</button>\r
        <div id="position"></div>\r
\r
...
\r
            ...
            const SpriteMaterial = new THREE.SpriteMaterial({\r
                map: new THREE.TextureLoader().load("../tree3.png"),\r
                color: 0x666666,\r
                transparent: true,\r
                opacity: 0.9,\r
            });\r
...
`,w=JSON.parse('{"title":"贴地模型组","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/30.groundGroup.md","filePath":"3.exampls/30.groundGroup.md","lastUpdated":1761368239000}'),u={name:"3.exampls/30.groundGroup.md"},B=Object.assign(u,{setup(F){const a=r(!0);return(b,s)=>{const e=l("ClientOnly");return h(),p("div",null,[s[1]||(s[1]=t("h1",{id:"贴地模型组",tabindex:"-1"},[d("贴地模型组 "),t("a",{class:"header-anchor",href:"#贴地模型组","aria-label":'Permalink to "贴地模型组"'},"​")],-1)),k(i(n(g),null,null,512),[[E,a.value]]),i(e,null,{default:c(()=>[i(n(m),{title:"Example",description:"随机在地面添加一批树",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(y)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=o(`<p>当模型需要贴在地面上，比如建筑物、树木等，需要计算模型所在地面海拔高度才能准确贴地，代码略显繁琐。为了简化贴地操作，three-tile 提供 GroundGroup 插件，它继承 threejs 的 Group 对象，只要将模型、精灵等加入 GroundGroup，就能够自动贴地。</p><p>下面的代码以 sprite 方式，随机向地面添加 500 棵树：</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 创建贴地模型组</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  map: </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">new</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> THREE</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">TextureLoader</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">().</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">load</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;../tree1.webp&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">),</span></span>
