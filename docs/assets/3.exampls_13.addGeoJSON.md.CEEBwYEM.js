import{p,C as t,c as h,o as r,j as l,a4 as k,G as i,a2 as E,a as d,a5 as o,k as n,w as g}from"./chunks/framework.BZ48x_LH.js";import{R as c,k as y}from"./chunks/index.DCj37L2o.js";const u=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,D=JSON.parse('{"title":"添加 GeoJSON 数据","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/13.addGeoJSON.md","filePath":"3.exampls/13.addGeoJSON.md","lastUpdated":1761368239000}'),b={name:"3.exampls/13.addGeoJSON.md"},B=Object.assign(b,{setup(m){const a=p(!0);return(F,s)=>{const e=t("ClientOnly");return r(),h("div",null,[s[1]||(s[1]=l("h1",{id:"添加-geojson-数据",tabindex:"-1"},[d("添加 GeoJSON 数据 "),l("a",{class:"header-anchor",href:"#添加-geojson-数据","aria-label":'Permalink to "添加 GeoJSON 数据"'},"​")],-1)),k(i(n(c),null,null,512),[[o,a.value]]),i(e,null,{default:g(()=>[i(n(y),{title:"example",description:"加载geojson数据：https://geo.datav.aliyun.com",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=E(`<p>GeoJSON 数据支持，使用 three-tile 的 geojson 加载器插件完成。</p><h2 id="_1-使用方法" tabindex="-1">1. 使用方法 <a class="header-anchor" href="#_1-使用方法" aria-label="Permalink to &quot;1. 使用方法&quot;">​</a></h2><ol><li>注册 geojson 加载器：<code>tt.registerImgLoader(new plugin.GeoJSONLoader());</code></li><li>声明 geojson 数据源</li><li>设置 TileMap.imgSource 为 geojson 数据源</li><li>调用 TileMap.reload()重新加载</li></ol><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. 注册geosjon数据加载器：</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  url: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;../city.geojson&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span></span>
