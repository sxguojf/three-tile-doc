import{p as i,C as l,c as s,o as c,j as t,a4 as p,G as n,a as d,a5 as m,k as e,w as u}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as h,VitepressDemoBox as g}from"vitepress-demo-plugin";const f=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    // ==============================================================\r
    // 创建挤压几何体\r
    export function createExtrudedMesh(map, coordinates, depth = 12000) {\r
        // 墨卡托投影函数\r
...
\r
        ...
        return new THREE.Mesh(geometry, [undefined, material]);\r
    }\r
\r
...
<\/script>\r
`,S=JSON.parse('{"title":"34. 用 geojson 挖洞或剪裁","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/34.polyHole/index.md","filePath":"3.examples/34.polyHole/index.md","lastUpdated":1773556276000}'),w={name:"3.examples/34.polyHole/index.md"},T=Object.assign(w,{setup(v){const o=i(!0);return(x,r)=>{const a=l("ClientOnly");return c(),s("div",null,[r[1]||(r[1]=t("h1",{id:"_34-用-geojson-挖洞或剪裁",tabindex:"-1"},[d("34. 用 geojson 挖洞或剪裁 "),t("a",{class:"header-anchor",href:"#_34-用-geojson-挖洞或剪裁","aria-label":'Permalink to "34. 用 geojson 挖洞或剪裁"'},"​")],-1)),p(n(e(h),null,null,512),[[m,o.value]]),n(a,null,{default:u(()=>[n(e(g),{title:"example",description:"点击右上角按钮挖洞或剪裁",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:r[0]||(r[0]=()=>{o.value=!1}),htmlCode:e(f)},null,8,["htmlCode"])]),_:1})])}}});export{S as __pageData,T as default};
