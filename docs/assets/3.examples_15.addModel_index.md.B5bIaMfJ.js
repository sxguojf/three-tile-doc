import{p as t,C as l,c as p,o as h,j as e,a4 as o,G as i,a2 as d,a as k,a5 as c,k as n,w as E}from"./chunks/framework.xbTv8SNN.js";import{I as g,$ as m}from"./chunks/index.Dw17pxVn.js";const y=`<!doctype html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,v=JSON.parse('{"title":"15. 添加 GLTF 模型","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/15.addModel/index.md","filePath":"3.examples/15.addModel/index.md","lastUpdated":1773556276000}'),u={name:"3.examples/15.addModel/index.md"},C=Object.assign(u,{setup(F){const a=t(!0);return(b,s)=>{const r=l("ClientOnly");return h(),p("div",null,[s[1]||(s[1]=e("h1",{id:"_15-添加-gltf-模型",tabindex:"-1"},[k("15. 添加 GLTF 模型 "),e("a",{class:"header-anchor",href:"#_15-添加-gltf-模型","aria-label":'Permalink to "15. 添加 GLTF 模型"'},"​")],-1)),o(i(n(g),null,null,512),[[c,a.value]]),i(r,null,{default:E(()=>[i(n(m),{title:"example",description:"添加GLTF模型，并添加灯光和阴影",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(y)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=d(`<p>本节与 <code>9. 添加简单模型</code> 方法完全一样，只不过模型换成了 GLTF 模型。</p><h2 id="_1-加载-gltf-模型" tabindex="-1">1. 加载 gltf 模型 <a class="header-anchor" href="#_1-加载-gltf-模型" aria-label="Permalink to &quot;1. 加载 gltf 模型&quot;">​</a></h2><p>使用 GLTFLoader 加载模型，模型加载后，将模型放置在指定经纬度高度，与 <code>threejs</code> 加载模型方法无异。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 地图中心经纬度高度</span></span>
