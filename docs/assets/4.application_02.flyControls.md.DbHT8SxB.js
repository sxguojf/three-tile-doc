const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/02.DpSeZEB2.js","assets/chunks/index.DTcE6LeP.js","assets/chunks/useSky.BJdHTgn1.js","assets/chunks/useState.D--43xZA.js","assets/chunks/framework.BZ48x_LH.js"])))=>i.map(i=>d[i]);
import{p as h,D as k,v as o,V as d,C as c,c as E,o as g,j as t,a4 as y,G as i,a2 as u,a as F,a5 as m,k as n,w as r,a6 as b}from"./chunks/framework.BZ48x_LH.js";import{R as v,k as A}from"./chunks/index.DCj37L2o.js";const D=`<script setup lang="ts">\r
...
\r
    // 加载音效\r
    const audio = new Audio("../sounds/plane3.mp3");\r
    audio.loop = true;\r
    // 音效控制\r
...
`,x=JSON.parse('{"title":"第三人称飞行","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/02.flyControls.md","filePath":"4.application/02.flyControls.md","lastUpdated":1761471651000}'),f={name:"4.application/02.flyControls.md"},_=Object.assign(f,{setup(C){const e=h(!0),a=k();return o(async()=>{a.value=(await d(async()=>{const{default:l}=await import("./chunks/02.DpSeZEB2.js");return{default:l}},__vite__mapDeps([0,1,2,3,4]))).default}),(l,s)=>{const p=c("ClientOnly");return g(),E("div",null,[s[1]||(s[1]=t("h1",{id:"第三人称飞行",tabindex:"-1"},[F("第三人称飞行 "),t("a",{class:"header-anchor",href:"#第三人称飞行","aria-label":'Permalink to "第三人称飞行"'},"​")],-1)),y(i(n(v),null,null,512),[[m,e.value]]),i(p,null,{default:r(()=>[i(n(A),{title:"vue演示",description:"按任意键开始，WASD 键控制水平移动，RF 键控制升降，上下左右键控制转向，或用鼠标引导飞行方向",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{e.value=!1}),vueCode:n(D)},b({_:2},[a.value?{name:"vue",fn:r(()=>[i(n(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[2]||(s[2]=u(`<p><code>threejs</code> 提供了 <code>FlyControls</code> 控制器，能够真实模拟飞行场景，但官方示例 ( <a href="https://threejs.org/examples/?q=fly#misc_controls_fly" target="_blank" rel="noreferrer">https://threejs.org/examples/?q=fly#misc_controls_fly</a> ) 根本看不懂控制器在干啥，感觉完全失控了。其实 <code>FlyControls</code> 是一个非常好的控制器，可用于飞行游戏，用键盘或鼠标控制飞机，像飞机一样翻滚，只是作者没有写出好的示例，未能体现出它的价值。</p><p>将场景控制器更换为 <code>FlyControls</code>，添加一个飞机模型，仅需数十行代码即可完成一个第三人称飞行游戏。</p><h2 id="_1-更换控制器" tabindex="-1">1. 更换控制器 <a class="header-anchor" href="#_1-更换控制器" aria-label="Permalink to &quot;1. 更换控制器&quot;">​</a></h2><p><code>three-tile</code> 的地图模型不依赖特定 <code>controls</code>，所以可以更换任意控制器，跟上个示例第一人称射击一样，将控制器更换为 <code>FlyControls</code> ( <a href="https://threejs.org/docs/?q=fly#examples/zh/controls/FlyControls" target="_blank" rel="noreferrer">https://threejs.org/docs/?q=fly#examples/zh/controls/FlyControls</a>)</p><h2 id="_2-飞行" tabindex="-1">2. 飞行 <a class="header-anchor" href="#_2-飞行" aria-label="Permalink to &quot;2. 飞行&quot;">​</a></h2><p>加载一个模型，如小鸟、飞机，固定在摄像机前面，<code>FlyControls</code> 会自动完成飞行控制功能。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">};</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br></div></div>`,7))])}}});export{x as __pageData,_ as default};
