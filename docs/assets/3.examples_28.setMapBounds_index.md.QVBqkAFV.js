import{p as o,C as a,c as d,o as h,j as r,a4 as c,G as s,a2 as k,a as t,a5 as u,k as e,w as m}from"./chunks/framework.xbTv8SNN.js";import{I as E,$ as g}from"./chunks/index.Dw17pxVn.js";const b=`<!doctype html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,y={id:"_28-设置地图经纬度范围",tabindex:"-1"},C=JSON.parse('{"title":"28. 设置地图经纬度范围","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/28.setMapBounds/index.md","filePath":"3.examples/28.setMapBounds/index.md","lastUpdated":1773556276000}'),w={name:"3.examples/28.setMapBounds/index.md"},_=Object.assign(w,{setup(v){const i=o(!0);return(x,n)=>{const l=a("Badge"),p=a("ClientOnly");return h(),d("div",null,[r("h1",y,[n[1]||(n[1]=t("28. 设置地图经纬度范围")),s(l,{type:"tip",text:"≥0.11.5"}),n[2]||(n[2]=t()),n[3]||(n[3]=r("a",{class:"header-anchor",href:"#_28-设置地图经纬度范围","aria-label":'Permalink to "28. 设置地图经纬度范围<Badge type="tip" text="≥0.11.5" />"'},"​",-1))]),c(s(e(E),null,null,512),[[u,i.value]]),s(p,null,{default:m(()=>[s(e(g),{title:"example",description:"设置地图经纬度范围：bounds: [60, 0, 145, 60]",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:n[0]||(n[0]=()=>{i.value=!1}),htmlCode:e(b)},null,8,["htmlCode"])]),_:1}),n[4]||(n[4]=k(`<p>V0.11.5 地图增加了经纬度范围属性：<code>bounds: [最小经度，最小纬度，最小经度，最大纬度]</code></p><p>设置地图经纬度范围属性 <code>TileMap.bounds</code> 后，地图仅下载和渲染 <code>bounds</code> 范围的数据，以减少地图下载量提高渲染速度。</p><p>该属性默认为 <code>undefined</code>，表示不对地图范围进行控制，即显示全球数据。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 创建地图</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 增加：地图经纬度范围 [最小经度，最小纬度，最大经度，最大纬度]</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br></div></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p><code>TileMap.bunds</code> 属性是是设置整个地图的经纬度范围，如果要设置某一层数据经纬度范围，设置数据源的 <code>bounds</code> 属性来控制。</p></div>`,5))])}}});export{C as __pageData,_ as default};
