import{p as l,C as i,c as s,o as p,j as a,a4 as d,G as r,a as c,a5 as m,k as t,w as h}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as u,VitepressDemoBox as v}from"vitepress-demo-plugin";const w=`<style>\r
    html,\r
    body {\r
        color: #eee;\r
...
\r
<\/script>\r
`,S=JSON.parse('{"title":"37. 加载本地 splat 模型","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/37.splatDrei/index.md","filePath":"3.examples/37.splatDrei/index.md","lastUpdated":1773556276000}'),f={name:"3.examples/37.splatDrei/index.md"},F=Object.assign(f,{setup(g){const n=l(!0);return(x,e)=>{const o=i("ClientOnly");return p(),s("div",null,[e[1]||(e[1]=a("h1",{id:"_37-加载本地-splat-模型",tabindex:"-1"},[c("37. 加载本地 splat 模型 "),a("a",{class:"header-anchor",href:"#_37-加载本地-splat-模型","aria-label":'Permalink to "37. 加载本地 splat 模型"'},"​")],-1)),d(r(t(u),null,null,512),[[m,n.value]]),r(o,null,{default:h(()=>[r(t(v),{title:"example",description:"参考：https://drei.docs.pmnd.rs/abstractions/splat#splat",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{n.value=!1}),htmlCode:t(w)},null,8,["htmlCode"])]),_:1})])}}});export{S as __pageData,F as default};
