import{p as h,C as e,c as o,o as d,j as r,a4 as c,G as n,a2 as k,a as l,a5 as m,k as a,w as g}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as u,VitepressDemoBox as E}from"vitepress-demo-plugin";const b=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
<div class="controls">\r
    ...
    <button onclick="handleFilter()">自定义着色器</button>\r
...
\r
    ...
    const centerPosition = map.geo2world(new THREE.Vector3(116.4, 39.92, 0));\r
    // 摄像机经纬度高度（m）转为世界坐标\r
...
\r
    window.handleFilter = function () {\r
        // 修改影像加载器的材质\r
        const loader = tt.getImgLoader("image");\r
        loader.material = new Filter({ color: 0xaaccff });\r
        map.reload();\r
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">map.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">reload</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>每块瓦片的材质均是从该着色器 <code>clone</code> 而来，各个材质没有关联，所以运行时修改材质的属性如颜色，已有瓦片并不会实时响应。如果要实现实时调整颜色等属性的功能，有两种方案：</p><ol><li>修改材质属性时，遍历所有瓦片修改每个瓦片的材质属性。效率略低，使用 threejs 内置材质时建议使用该方法。</li><li>重写材质的<code>copy</code>函数，<code>clone</code> 时，将材质的 uniform 以引用方式传递而不是复制，让所有瓦片的材质的 uniform 指向同一个对象。使用自定义着色器时建议使用该方法。</li></ol></div>`,10))])}}});export{w as __pageData,_ as default};
