import{p as i,C as l,c as o,o as p,j as r,a4 as d,G as n,a2 as c,a as h,a5 as m,k as t,w as u}from"./chunks/framework.xbTv8SNN.js";import{R as k,k as b}from"./chunks/index.T3-yMMRo.js";const g=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,x=JSON.parse('{"title":"36. 使用 LumaSplatsThree 加载 splat 模型","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/36.splatLuma/index.md","filePath":"3.exampls/36.splatLuma/index.md","lastUpdated":1765123930000}'),E={name:"3.exampls/36.splatLuma/index.md"},C=Object.assign(E,{setup(f){const a=i(!0);return(v,e)=>{const s=l("ClientOnly");return p(),o("div",null,[e[1]||(e[1]=r("h1",{id:"_36-使用-lumasplatsthree-加载-splat-模型",tabindex:"-1"},[h("36. 使用 LumaSplatsThree 加载 splat 模型 "),r("a",{class:"header-anchor",href:"#_36-使用-lumasplatsthree-加载-splat-模型","aria-label":'Permalink to "36. 使用 LumaSplatsThree 加载 splat 模型"'},"​")],-1)),d(n(t(k),null,null,512),[[m,a.value]]),n(s,null,{default:u(()=>[n(t(b),{title:"example",description:"参考：https://github.com/lumalabs/luma-web-examples",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:e[0]||(e[0]=()=>{a.value=!1}),htmlCode:t(g)},null,8,["htmlCode"])]),_:1}),e[2]||(e[2]=c(`<p>使用 <a href="https://github.com/lumalabs/luma-web-examples" target="_blank" rel="noreferrer">LumaSplatsThree</a> 加载 splat 模型：</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> splat</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> LumaSplatsThree</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">viewer.scene.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">add</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(splat);</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>因 <code>LumaSplatsThree</code> 的着色器未考虑对数深度，所以需要关闭 <code>Renderer</code> 的 <code>logarithmicDepthBuffer</code> 属性，否则 <code>splat</code> 模型会被地图遮挡。</p></div>`,3))])}}});export{x as __pageData,C as default};
