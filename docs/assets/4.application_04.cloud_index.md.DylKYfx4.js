...
import{p as c,D as d,v as p,V as m,C as u,c as v,o as w,j as t,a4 as f,G as n,a as h,a5 as g,k as a,w as l,a6 as x}from"./chunks/framework.xbTv8SNN.js";import{I as b,$ as M}from"./chunks/index.Dw17pxVn.js";const _=`<template>
...
`,k=JSON.parse('{"title":"4. 伪三维卫星云图","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/04.cloud/index.md","filePath":"4.application/04.cloud/index.md","lastUpdated":1765361805000}'),y={name:"4.application/04.cloud/index.md"},T=Object.assign(y,{setup(V){const i=c(!0),o=d();return p(async()=>{o.value=(await m(async()=>{const{default:r}=await import("./chunks/Cloud.jaZOtxPL.js");return{default:r}},__vite__mapDeps([0,1,2,3]))).default}),(r,e)=>{const s=u("ClientOnly");return w(),v("div",null,[e[1]||(e[1]=t("h1",{id:"_4-伪三维卫星云图",tabindex:"-1"},[h("4. 伪三维卫星云图 "),t("a",{class:"header-anchor",href:"#_4-伪三维卫星云图","aria-label":'Permalink to "4. 伪三维卫星云图"'},"​")],-1)),f(n(a(b),null,null,512),[[g,i.value]]),n(s,null,{default:l(()=>[n(a(M),{title:"vue演示",description:"伪三维卫星云图",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{i.value=!1}),vueCode:a(_)},x({_:2},[o.value?{name:"vue",fn:l(()=>[n(a(o))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),e[2]||(e[2]=t("p",null,"常用的卫星云是红外云图，它是一张二维灰度图片，像素值代表云顶亮温，亮温又与云顶高度相关，有了每个点的高度就可以模拟云的三维效果。",-1))])}}});export{k as __pageData,T as default};
