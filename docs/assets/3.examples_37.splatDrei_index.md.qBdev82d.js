import{p as l,C as s,c as i,o as p,j as a,a4 as d,G as e,a as c,a5 as m,k as t,w as h}from"./chunks/framework.xbTv8SNN.js";import{I as u,$ as v}from"./chunks/index.Dw17pxVn.js";const f=`<style>\r
    html,\r
    body {\r
        color: #eee;\r
...
\r
<\/script>\r
`,_=JSON.parse('{"title":"37. 加载本地 splat 模型","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/37.splatDrei/index.md","filePath":"3.examples/37.splatDrei/index.md","lastUpdated":1773556276000}'),w={name:"3.examples/37.splatDrei/index.md"},S=Object.assign(w,{setup(g){const n=l(!0);return(x,r)=>{const o=s("ClientOnly");return p(),i("div",null,[r[1]||(r[1]=a("h1",{id:"_37-加载本地-splat-模型",tabindex:"-1"},[c("37. 加载本地 splat 模型 "),a("a",{class:"header-anchor",href:"#_37-加载本地-splat-模型","aria-label":'Permalink to "37. 加载本地 splat 模型"'},"​")],-1)),d(e(t(u),null,null,512),[[m,n.value]]),e(o,null,{default:h(()=>[e(t(v),{title:"example",description:"参考：https://drei.docs.pmnd.rs/abstractions/splat#splat",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:r[0]||(r[0]=()=>{n.value=!1}),htmlCode:t(f)},null,8,["htmlCode"])]),_:1})])}}});export{_ as __pageData,S as default};
