import{p as l,C as r,c as h,o as p,j as e,a4 as k,G as i,a2 as E,a as d,a5 as o,k as n,w as g}from"./chunks/framework.BZ48x_LH.js";import{R as y,k as c}from"./chunks/index.DCj37L2o.js";const u=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,B=JSON.parse('{"title":"添加 SKY","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/16.addSky.md","filePath":"3.exampls/16.addSky.md","lastUpdated":1761368239000}'),C={name:"3.exampls/16.addSky.md"},v=Object.assign(C,{setup(m){const a=l(!0);return(F,s)=>{const t=r("ClientOnly");return p(),h("div",null,[s[1]||(s[1]=e("h1",{id:"添加-sky",tabindex:"-1"},[d("添加 SKY "),e("a",{class:"header-anchor",href:"#添加-sky","aria-label":'Permalink to "添加 SKY"'},"​")],-1)),k(i(n(y),null,null,512),[[o,a.value]]),i(t,null,{default:g(()=>[i(n(c),{title:"example",description:"添加天空，使用threejs内置的Sky",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=E(`<h2 id="直接把-threejs-的-sky-示例搬过来即可" tabindex="-1">直接把 threejs 的 sky 示例搬过来即可 <a class="header-anchor" href="#直接把-threejs-的-sky-示例搬过来即可" aria-label="Permalink to &quot;直接把 threejs 的 sky 示例搬过来即可&quot;">​</a></h2><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//添加Sky</span></span>
