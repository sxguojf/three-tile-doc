import{p,C as t,c as r,o as h,j as e,a4 as k,G as i,a2 as d,a as o,a5 as E,k as n,w as c}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as g,VitepressDemoBox as y}from"vitepress-demo-plugin";const m=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    ...
    const sphere1 = createSphere(0x00ff00);\r
...
\r
    ...
    const sphere2 = createSphere(0x0000ff);\r
    // 设置球体坐标\r
...
<\/script>\r
`,A=JSON.parse('{"title":"9. 添加模型","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/09.addMesh/index.md","filePath":"3.examples/09.addMesh/index.md","lastUpdated":1790261744000}'),u={name:"3.examples/09.addMesh/index.md"},f=Object.assign(u,{setup(b){const a=p(!0);return(F,s)=>{const l=t("ClientOnly");return h(),r("div",null,[s[1]||(s[1]=e("h1",{id:"_9-添加模型",tabindex:"-1"},[o("9. 添加模型 "),e("a",{class:"header-anchor",href:"#_9-添加模型","aria-label":'Permalink to "9. 添加模型"'},"​")],-1)),k(i(n(g),null,null,512),[[E,a.value]]),i(l,null,{default:c(()=>[i(n(y),{title:"example",description:"添加两个球，绿球加入场景（场景全局坐标系），蓝球加入地图（地图模型局地坐标系）",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(m)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=d(`<h2 id="_1-创建一个模型" tabindex="-1">1. 创建一个模型 <a class="header-anchor" href="#_1-创建一个模型" aria-label="Permalink to &quot;1. 创建一个模型&quot;">​</a></h2><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 创建一个2000m半径的球体</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div><p>两种方式唯一不同是：加入场景中时，模型高度在 y 轴，需要调整模型 y 坐标；加入地图中时，模型高度在 z 轴，需要调整模型 z 坐标，</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>模型加入场景和加入地图效果上没有本质区别，只是加入地图时，模型能跟随地图拉伸，如对地形进行夸张处理时，模型高度比例也随地形一起被拉伸，一般建议将模型加入地图。如果添加的模型较多，建议用将多个模型加入一个 Group，然后将 Group 加入地图，以方便管理。</p></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>同样方法，可以在地图上添加任意模型，如 threejs 提供的中几何体、sprite、gltf 模型，借助插件添加 3dTiles、点云等。</p></div>`,17))])}}});export{A as __pageData,f as default};
