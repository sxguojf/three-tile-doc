import{p as r,C as t,c as p,o as h,j as e,a4 as k,G as n,a2 as d,a as o,a5 as c,k as i,w as g}from"./chunks/framework.xbTv8SNN.js";import{I as E,$ as m}from"./chunks/index.Dw17pxVn.js";const u=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
<\/script>\r
`,v=JSON.parse('{"title":"22. 贴地图片","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/22.singleImage/index.md","filePath":"3.examples/22.singleImage/index.md","lastUpdated":1773556276000}'),y={name:"3.examples/22.singleImage/index.md"},x=Object.assign(y,{setup(b){const a=r(!0);return(F,s)=>{const l=t("ClientOnly");return h(),p("div",null,[s[1]||(s[1]=e("h1",{id:"_22-贴地图片",tabindex:"-1"},[o("22. 贴地图片 "),e("a",{class:"header-anchor",href:"#_22-贴地图片","aria-label":'Permalink to "22. 贴地图片"'},"​")],-1)),k(n(i(E),null,null,512),[[c,a.value]]),n(l,null,{default:g(()=>[n(i(m),{title:"example",description:"单张图片贴地",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:i(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=d(`<p>贴地图片由 <code>single-image</code> 插件支持，使用方法与 <code>22.单TIFF地形</code>几乎一样。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 注册单影像加载器</span></span>
