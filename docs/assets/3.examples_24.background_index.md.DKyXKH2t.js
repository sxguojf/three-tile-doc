import{p as h,C as e,c as o,o as d,j as t,a4 as k,G as n,a2 as c,a as r,a5 as g,k as i,w as m}from"./chunks/framework.xbTv8SNN.js";import{I as u,$ as E}from"./chunks/index.Dw17pxVn.js";const b=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
<\/script>\r
`,y={id:"_24-地图背景",tabindex:"-1"},D=JSON.parse('{"title":"24. 地图背景","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/24.background/index.md","filePath":"3.examples/24.background/index.md","lastUpdated":1773556276000}'),v={name:"3.examples/24.background/index.md"},_=Object.assign(v,{setup(x){const a=h(!0);return(C,s)=>{const l=e("Badge"),p=e("ClientOnly");return d(),o("div",null,[t("h1",y,[s[1]||(s[1]=r("24. 地图背景")),n(l,{type:"tip",text:"≥0.11.9"}),s[2]||(s[2]=r()),s[3]||(s[3]=t("a",{class:"header-anchor",href:"#_24-地图背景","aria-label":'Permalink to "24. 地图背景<Badge type="tip" text="≥0.11.9" />"'},"​",-1))]),k(n(i(u),null,null,512),[[g,a.value]]),n(p,null,{default:m(()=>[n(i(E),{title:"example",description:"简单地图，右上角调整地图背景色",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:i(b)},null,8,["htmlCode"])]),_:1}),s[4]||(s[4]=c(`<p>有的时候，我们仅需要显示不含卫星影像，仅包含境界、地名的简单地图，甚至不需要地形的二维地图， 但由于境界、地名瓦片背景透明，地图无背景色时会穿透到地下。</p><p>V0.11.4 TileMap 增加了背景色属性：backgroundColor，但它不够灵活，已废弃。</p><p>V0.11.9 增加了背景加载器，通过数据源方式加载背景色，仅是对去掉了 backgroundColor 属性的临时替代方案。</p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>添加地图背景功能比较鸡肋，一般应用并不需要显示透明背景的底图。如果确有需求，建议使用 <code>26. 自定义瓦片着色器</code> 实现，它的效果更好一些。</p></div><h2 id="背景加载器使用" tabindex="-1">背景加载器使用 <a class="header-anchor" href="#背景加载器使用" aria-label="Permalink to &quot;背景加载器使用&quot;">​</a></h2><ol><li>注册背景加载器</li><li>声明背景数据源</li><li>添加背景</li></ol><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. 注册背景加载器</span></span>
