import{p as i,C as s,c as l,o as d,j as o,a4 as c,G as r,a2 as h,a as p,a5 as m,k as n,w as u}from"./chunks/framework.xbTv8SNN.js";import{I as w,$ as g}from"./chunks/index.Dw17pxVn.js";const x=`<!doctype html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,_=JSON.parse('{"title":"11. 添加阴影","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/11.addShadow/index.md","filePath":"3.examples/11.addShadow/index.md","lastUpdated":1773556276000}'),v={name:"3.examples/11.addShadow/index.md"},y=Object.assign(v,{setup(b){const t=i(!0);return(f,e)=>{const a=s("ClientOnly");return d(),l("div",null,[e[1]||(e[1]=o("h1",{id:"_11-添加阴影",tabindex:"-1"},[p("11. 添加阴影 "),o("a",{class:"header-anchor",href:"#_11-添加阴影","aria-label":'Permalink to "11. 添加阴影"'},"​")],-1)),c(r(n(w),null,null,512),[[m,t.value]]),r(a,null,{default:u(()=>[r(n(g),{title:"example",description:"添加一个球，开启灯光和阴影",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{t.value=!1}),htmlCode:n(x)},null,8,["htmlCode"])]),_:1}),e[2]||(e[2]=h('<p>阴影是提高场景真实感的重要因素之一，你的模型为什么看着有些假？很可能是没有阴影。</p><p>three-tile 使用阴影和 threejs 一致：</p><ol><li>开启渲染器阴影功能：<code>renderer.shadowMap.enabled = true;</code></li><li>开启灯光投射阴影：<code>light.castShadow = true;</code></li><li>开启模型投射阴影：<code>mesh.castShadow = true;</code></li><li>开启地面接受阴影：<code>map.receiveShadow = true;</code></li></ol><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>地图虽然是有若干块瓦片模型组成，但并不需要遍历瓦片开启阴影，three-tile 已经在内部进行处理。</p></div><h2 id="使用阴影需要注意" tabindex="-1">使用阴影需要注意： <a class="header-anchor" href="#使用阴影需要注意" aria-label="Permalink to &quot;使用阴影需要注意：&quot;">​</a></h2><ol><li>阴影比较耗费资源，建议单独添加一个产生阴影的灯光，不要使用全局的直射光阴影。</li><li>可添加灯光、灯光摄像机等 helper 以方便调试。</li><li>为节省资源，尽量缩小阴影投射范围。</li><li>为了方便使用，TileMap 的 castShadow 和 receiveShadow 属性会自动应用全部子瓦片，不需要手动遍历开启。</li><li>开启地形自身阴影（用于产生山体阴影）作用不明显，因为卫星影像拍摄时已包含阴影，所以一般不开启。</li></ol>',6))])}}});export{_ as __pageData,y as default};
