import{p as t,C as l,c as p,o as h,j as e,a4 as o,G as i,a2 as k,a as d,a5 as c,k as n,w as E}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as g,VitepressDemoBox as m}from"vitepress-demo-plugin";const u=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    ...
    const map = tt.TileMap.create({\r
        ...
        minLevel: 6,\r
        // 地图显示范围\r
        bounds: [107.6, 35.3, 110.6, 37.5],\r
    });\r
    // 地图旋转到xz平面\r
...
\r
    ...
    const centerPosition = map.geo2world(new THREE.Vector3(109.2, 36.2, 0));\r
    // 摄像机经纬度高度（m）转为世界坐标\r
...
\r
    ...
    // 限制地图移动范围\r
\r
    const minPan = map.geo2world(new THREE.Vector3(107.6, 37.5)); // 西北角经纬度（世界坐标 min）\r
    const maxPan = map.geo2world(new THREE.Vector3(110.6, 35.3)); // 东南角经纬度（世界坐标 max）\r
\r
    // 加一个范围边框\r
...
<\/script>\r
`,x=JSON.parse('{"title":"31. 限制地图移动和缩小","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/31.limitPan/index.md","filePath":"3.examples/31.limitPan/index.md","lastUpdated":1790261744000}'),y={name:"3.examples/31.limitPan/index.md"},B=Object.assign(y,{setup(b){const a=t(!0);return(v,s)=>{const r=l("ClientOnly");return h(),p("div",null,[s[1]||(s[1]=e("h1",{id:"_31-限制地图移动和缩小",tabindex:"-1"},[d("31. 限制地图移动和缩小 "),e("a",{class:"header-anchor",href:"#_31-限制地图移动和缩小","aria-label":'Permalink to "31. 限制地图移动和缩小"'},"​")],-1)),o(i(n(g),null,null,512),[[c,a.value]]),i(r,null,{default:E(()=>[i(n(m),{title:"Example",description:"地图只能在设定范围移动",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=k(`<p>默认情况，地图是可以随意拖动的，但在一些场景中，我们希望限制地图只能在某个区域内移动，以防止地图拖的找不到了，这对显示小范围地图比较有用。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 限制地图移动范围</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> minPan</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> map.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">geo2world</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">new</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> THREE</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">Vector3</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">107.6</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">37.5</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)); </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 西北角经纬度（世界坐标 min）</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> maxPan</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> map.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">geo2world</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">new</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> THREE</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">Vector3</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">110.6</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">35.3</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)); </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 东南角经纬度（世界坐标 max）</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">viewer.controls.maxDistance </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 1000000</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div>`,4))])}}});export{x as __pageData,B as default};
