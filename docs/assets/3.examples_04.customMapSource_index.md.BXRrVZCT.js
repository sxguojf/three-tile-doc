import{p,C as t,c as r,o as h,j as l,a4 as k,G as i,a2 as d,a as o,a5 as c,k as a,w as g}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as E,VitepressDemoBox as u}from"vitepress-demo-plugin";const y="/three-tile-doc/assets/image.DPtNRNOY.png",b=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
<\/script>\r
`,x=JSON.parse('{"title":"4. 自定义地图数据源","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/04.customMapSource/index.md","filePath":"3.examples/04.customMapSource/index.md","lastUpdated":1790261744000}'),m={name:"3.examples/04.customMapSource/index.md"},v=Object.assign(m,{setup(F){const n=p(!0);return(A,s)=>{const e=t("ClientOnly");return h(),r("div",null,[s[1]||(s[1]=l("h1",{id:"_4-自定义地图数据源",tabindex:"-1"},[o("4. 自定义地图数据源 "),l("a",{class:"header-anchor",href:"#_4-自定义地图数据源","aria-label":'Permalink to "4. 自定义地图数据源"'},"​")],-1)),k(i(a(E),null,null,512),[[c,n.value]]),i(e,null,{default:g(()=>[i(a(u),{title:"Example",description:"点击地图右上角厂商名称切换地图数据",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{n.value=!1}),htmlCode:a(b)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=d(`<p>地图创建时需要指定瓦片地图数据源，three-tile 内置了主流厂商的地图数据源定义，但你也可以自定义新的地图数据源，或自行切瓦片、下载离线瓦片使用自己的地图服务。</p><p>three-tile 的数据源分两大类：</p><ol><li>影像瓦片：即我们通常看到的影像地图瓦片。支持 png、jpg、webp 等格式。</li><li>地形瓦片：即高程数据瓦片，用于地形渲染。支持 MapBox 的 terrain-rgb、ArcGis 的 LERC 格式。</li></ol><p>three-tile 的地图数据的加载、解析和瓦片模型的创建使用插件架构实现，可以灵活扩展。 目前加载器插件有：geojson、mvt、tif、wireframe、logo、normal、debug 等。</p><h2 id="_1-内置数据源" tabindex="-1">1. 内置数据源 <a class="header-anchor" href="#_1-内置数据源" aria-label="Permalink to &quot;1. 内置数据源&quot;">​</a></h2><p>包括：ArcGis、MapBox、google、bing、天地图、中科星图、高德、腾讯等等。这些数据源可以直接使用。数据源定义在 <code>plugin</code> 模块。</p><ul><li>MapBoxSource,</li><li>ArcGisSource,</li><li>ArcGisDemSource,</li><li>BingSource,</li><li>GDSource,</li><li>GeoqSource,</li><li>GoogleSource,</li><li>MapTilerSource,</li><li>StadiaSource,</li><li>TDTSource,</li><li>TXSource,</li><li>ZKXTSource</li></ul><p>如使用 MapBox 数据源：</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// MapBoxToken 请更换为你自己申请的key</span></span>
