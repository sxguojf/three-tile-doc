import{p as t,C as r,c as h,o as p,j as e,a4 as k,G as i,a2 as E,a as d,a5 as o,k as n,w as g}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as y,VitepressDemoBox as c}from"vitepress-demo-plugin";const u=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    ...
    viewer.dirLight.intensity = 2;\r
    viewer.scene.fog.color.set(0);\r
    viewer.renderer.toneMapping = THREE.ACESFilmicToneMapping;\r
    viewer.renderer.toneMappingExposure = 0.6;\r
\r
    // 地图添加到场景\r
...
\r
    ...
    function fly() {\r
        ...
        const centerPosition = map.geo2world(new THREE.Vector3(115, 40, 0));\r
        // 摄像机世界坐标\r
        const cameraPosition = new THREE.Vector3(\r
            centerPosition.x,\r
            centerPosition.y + 5000,\r
            centerPosition.z + 30000,\r
        );\r
        // 摄像机飞到指定位置\r
...
\r
    const sun = viewer.dirLight.position; //new THREE.Vector3();\r
\r
    /// GUI\r
    const effectController = {\r
        turbidity: 10,\r
        rayleigh: 2,\r
        mieCoefficient: 0.02,\r
...
\r
    ...
    gui.add(effectController, "azimuth", -180, 180, 0.1).onChange(guiChanged).listen();\r
    gui.add(effectController, "exposure", 0, 1, 0.0001).onChange(guiChanged);\r
\r
    const folderClouds = gui.addFolder("Clouds");\r
    folderClouds.add(effectController, "cloudCoverage", 0, 1, 0.01).name("coverage").onChange(guiChanged);\r
    folderClouds.add(effectController, "cloudDensity", 0, 1, 0.01).name("density").onChange(guiChanged);\r
    folderClouds.add(effectController, "cloudElevation", 0, 1, 0.01).name("elevation").onChange(guiChanged);\r
\r
    guiChanged();\r
<\/script>\r
`,v=JSON.parse('{"title":"16. 添加 SKY","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/16.addSky/index.md","filePath":"3.examples/16.addSky/index.md","lastUpdated":1790261744000}'),C={name:"3.examples/16.addSky/index.md"},D=Object.assign(C,{setup(F){const a=t(!0);return(m,s)=>{const l=r("ClientOnly");return p(),h("div",null,[s[1]||(s[1]=e("h1",{id:"_16-添加-sky",tabindex:"-1"},[d("16. 添加 SKY "),e("a",{class:"header-anchor",href:"#_16-添加-sky","aria-label":'Permalink to "16. 添加 SKY"'},"​")],-1)),k(i(n(y),null,null,512),[[o,a.value]]),i(l,null,{default:g(()=>[i(n(c),{title:"example",description:"添加天空，使用threejs内置的Sky",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=E(`<p>直接把 threejs 的 sky 示例搬过来即可</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//添加Sky</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 太阳位置与场景平行光 dirLight 联动，复用 viewer.dirLight.position</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> sun</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> viewer.dirLight.position;</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">guiChanged</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br></div></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>调整 sky 参数，天空颜色会发生变化，但地图颜色不会发生变化，造成地面和天空交界部分过渡不太自然，需要调整雾的颜色以适应。</p></div>`,3))])}}});export{v as __pageData,D as default};
