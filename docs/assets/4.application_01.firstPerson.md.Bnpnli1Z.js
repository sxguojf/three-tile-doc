...
`,x=JSON.parse('{"title":"第一人称射击","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/01.firstPerson.md","filePath":"4.application/01.firstPerson.md","lastUpdated":1761368239000}'),B={name:"4.application/01.firstPerson.md"},_=Object.assign(B,{setup(f){const l=k(!0),n=r();return E(async()=>{n.value=(await d(async()=>{const{default:p}=await import("./chunks/01.Do25kNQV.js");return{default:p}},__vite__mapDeps([0,1,2,3,4]))).default}),(p,s)=>{const h=o("ClientOnly");return g(),c("div",null,[s[1]||(s[1]=e("h1",{id:"第一人称射击",tabindex:"-1"},[b("第一人称射击 "),e("a",{class:"header-anchor",href:"#第一人称射击","aria-label":'Permalink to "第一人称射击"'},"​")],-1)),y(i(a(C),null,null,512),[[u,l.value]]),i(h,null,{default:t(()=>[i(a(D),{title:"vue演示",description:"点击地图开始射击",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{l.value=!1}),vueCode:a(A)},m({_:2},[n.value?{name:"vue",fn:t(()=>[i(a(n))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[2]||(s[2]=F(`<p>游戏开发对地图框架的性能是一种考验，也是最好的测试。游戏具有极高的实时性，任何卡顿在游戏中将会暴露无遗。</p><ul><li><p><code>three-tile</code> 的地图支持全球海量地形，所以它不能像常规游戏那样在启动时进行数据预加载和预处理，所有地图数据都是实时加载的。在鼠标的移动中，地图视角会以极快速度切换，大量地图瓦片实时下载、解析、渲染，十分考验框架性能，如果游戏能流畅地在地图中运行，那框架性能就足以应付绝大多数应用了。</p></li><li><p>编写 <code>three-tile</code> 最初的目标其实是开发游戏，地图只能算是 <code>three-tile</code> 的一个扩展，但目前地图的应用场景远多于游戏，所以现在框架的重点已经偏向于地图开发了。</p></li></ul><h2 id="_1-更换控制器" tabindex="-1">1. 更换控制器 <a class="header-anchor" href="#_1-更换控制器" aria-label="Permalink to &quot;1. 更换控制器&quot;">​</a></h2><p>第一人称游戏的以玩家视角渲染地图，模拟玩家看到的真实世界，与常规地图相比，仅是使用的控制器即不同。</p><p>为了方便用户使用，three-tile 对第一人称场景进行了封装：<code>PLViewer</code>，使用<code>PLViewer</code>初始化场景即可。仅需数十行代码即可完成一个简单的第一人称射击游戏。</p><p><code>three-tile</code> 的地图不依赖 <code>camera</code>、<code>controls</code>，所以可以任意更换控制器，第一人称视角，只需要将控制器更换为 <code>threejs</code> 的 <code>FirstPersonControls</code>：</p><p><a href="https://threejs.org/docs/?q=controls#examples/zh/controls/FirstPersonControls" target="_blank" rel="noreferrer">https://threejs.org/docs/?q=controls#examples/zh/controls/FirstPersonControls</a></p><p>修改 GLViewer 将控制器换成 FirstPersonControls，可参考：</p><p><a href="https://threejs.org/examples/?q=controls#misc_controls_pointerlock" target="_blank" rel="noreferrer">https://threejs.org/examples/?q=controls#misc_controls_pointerlock</a></p><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>计划下个版本增加使用 FirstPersonControls 控制器的 Viewer （V0.11.4 已内置）。</p></div><h2 id="_2-射击" tabindex="-1">2. 射击 <a class="header-anchor" href="#_2-射击" aria-label="Permalink to &quot;2. 射击&quot;">​</a></h2><p>使用 <code>FirstPersonControls</code> 控制器，就能有一个第一人称视角的三维地图，只需要在鼠标单击时创建一个球飞出去就行了，只需要不到 100 行代码。</p><p>监听地图容器的 click 事件，当鼠标单击地图时：</p><pre><code>1. 创建一个球体作为炮弹加入地图
2. 球的起点为摄像机坐标
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> SphereGeometry</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(),</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    aBall.scale.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">setScalar</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(camera.position.y </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">/</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 40</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">);</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> endPostion</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> crossPoint </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">?</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> map.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">worldToLocal</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(crossPoint.point) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> map.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">worldToLocal</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(camera.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">localToWorld</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> Vector3</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">0</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">100</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> *</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 1000</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)));</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 球边飞边转</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> Tween</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(aBall.rotation).</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">to</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({ x: Math.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">PI</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, y: Math.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">PI</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, z: Math.</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">PI</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> }, delay).</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">start</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      });</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    // 后坐力</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> pos</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> camera.position.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">clone</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">();</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    camera.position.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sub</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(camera.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">getWorldDirection</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">new</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> Vector3</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">()).</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">multiplyScalar</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">1000</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">));</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    setTimeout</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(() </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      camera.position.</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">copy</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(pos);</span></span>
