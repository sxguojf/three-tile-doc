import{p as e,C as p,c as r,o as h,j as i,a4 as k,G as a,a2 as o,a as d,a5 as E,k as n,w as c}from"./chunks/framework.xbTv8SNN.js";import{I as g,$ as y}from"./chunks/index.Dw17pxVn.js";const m=`<!doctype html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,D=JSON.parse('{"title":"3. 调整地图位置和缩放","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/03.setMapZoom/index.md","filePath":"3.examples/03.setMapZoom/index.md","lastUpdated":1773582147000}'),b={name:"3.examples/03.setMapZoom/index.md"},w=Object.assign(b,{setup(u){const t=e(!0);return(F,s)=>{const l=p("ClientOnly");return h(),r("div",null,[s[1]||(s[1]=i("h1",{id:"_3-调整地图位置和缩放",tabindex:"-1"},[d("3. 调整地图位置和缩放 "),i("a",{class:"header-anchor",href:"#_3-调整地图位置和缩放","aria-label":'Permalink to "3. 调整地图位置和缩放"'},"​")],-1)),s[2]||(s[2]=i("p",null,"地图创建部分已讲过，地图的中心位置和缩放需要通过调整摄像机位置和姿态来实现。",-1)),k(a(n(g),null,null,512),[[E,t.value]]),a(l,null,{default:c(()=>[a(n(y),{title:"Example",description:"点击地图右上角地名调整地图位置和缩放",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{t.value=!1}),htmlCode:n(m)},null,8,["htmlCode"])]),_:1}),s[3]||(s[3]=o(`<p>三维场景下，地图的位置和缩放，是通过调整摄像机的位置和姿态来实现的。设置 camera 的 position 设置观察者的坐标、设置 controls.target.position 设置地图中心坐标。</p><p>这两个坐标可以根据经纬度和海拔高度计算得到。可以在地图和场景创建完成后立即设置地图初始位置，也可以在运行时调整，还可以利用 tween 进行动画调整。</p><h2 id="_1-设置地图初始位置" tabindex="-1">1. 设置地图初始位置 <a class="header-anchor" href="#_1-设置地图初始位置" aria-label="Permalink to &quot;1. 设置地图初始位置&quot;">​</a></h2><p>直接设置地图中心和摄像机位置</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 地图中心经纬度高度（m）</span></span>
