import{p,C as t,c as r,o as h,j as l,a4 as k,G as i,a2 as d,a as E,a5 as o,k as n,w as c}from"./chunks/framework.xbTv8SNN.js";import{R as g,k as y}from"./chunks/index.T3-yMMRo.js";const b=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,C=JSON.parse('{"title":"14. 添加矢量瓦片","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/14.addMVT/index.md","filePath":"3.exampls/14.addMVT/index.md","lastUpdated":1761902788000}'),u={name:"3.exampls/14.addMVT/index.md"},B=Object.assign(u,{setup(m){const a=p(!0);return(F,s)=>{const e=t("ClientOnly");return h(),r("div",null,[s[1]||(s[1]=l("h1",{id:"_14-添加矢量瓦片",tabindex:"-1"},[E("14. 添加矢量瓦片 "),l("a",{class:"header-anchor",href:"#_14-添加矢量瓦片","aria-label":'Permalink to "14. 添加矢量瓦片"'},"​")],-1)),k(i(n(g),null,null,512),[[o,a.value]]),i(e,null,{default:c(()=>[i(n(y),{title:"example",description:"加载矢量数据，数据来自： https://api.maptiler.com/tiles",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(b)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=d(`<div class="danger custom-block"><p class="custom-block-title">注意</p><p>本示例矢量瓦片数据来自 (<a href="https://api.maptiler.com/tiles" target="_blank" rel="noreferrer">https://api.maptiler.com/tiles</a>) , 地图数据不代表本人观点</p></div><p>对矢量瓦片支持，使用 three-tile 的 mvt 加载器插件完成。支持 MapBox 的 pbf 格式矢量瓦片。</p><h2 id="_1-使用方法" tabindex="-1">1. 使用方法 <a class="header-anchor" href="#_1-使用方法" aria-label="Permalink to &quot;1. 使用方法&quot;">​</a></h2><p>使用方法与加载 <code>geojson</code> 数据类似</p><ol><li>注册 <code>mvt</code> 加载器：<code>tt.registerImgLoader(new plugin.MVTLoader());</code></li><li>声明 矢量瓦片 数据源</li><li>设置 <code>TileMap.imgSource</code> 为 <code>mvt</code> 数据源</li></ol><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 1. 注册矢量瓦片MVT加载器</span></span>
