import{p as t,C as p,c as r,o as h,j as e,a4 as k,G as i,a2 as d,a as o,a5 as E,k as n,w as c}from"./chunks/framework.xbTv8SNN.js";import{I as g,$ as y}from"./chunks/index.Dw17pxVn.js";const m=`<!doctype html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,A=JSON.parse('{"title":"9. 添加模型","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/09.addMesh/index.md","filePath":"3.examples/09.addMesh/index.md","lastUpdated":1773556276000}'),u={name:"3.examples/09.addMesh/index.md"},D=Object.assign(u,{setup(b){const a=t(!0);return(F,s)=>{const l=p("ClientOnly");return h(),r("div",null,[s[1]||(s[1]=e("h1",{id:"_9-添加模型",tabindex:"-1"},[o("9. 添加模型 "),e("a",{class:"header-anchor",href:"#_9-添加模型","aria-label":'Permalink to "9. 添加模型"'},"​")],-1)),k(i(n(g),null,null,512),[[E,a.value]]),i(l,null,{default:c(()=>[i(n(y),{title:"example",description:"添加两个球，绿球加入场景（场景全局坐标系），蓝球加入地图（地图模型局地坐标系）",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:n(m)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=d(`<h2 id="_1-创建一个模型" tabindex="-1">1. 创建一个模型 <a class="header-anchor" href="#_1-创建一个模型" aria-label="Permalink to &quot;1. 创建一个模型&quot;">​</a></h2><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 创建一个2000m直径的球体</span></span>
