import{p as t,C as l,c as p,o as h,j as e,a4 as o,G as n,a2 as k,a as d,a5 as c,k as i,w as E}from"./chunks/framework.xbTv8SNN.js";import{I as g,$ as m}from"./chunks/index.Dw17pxVn.js";const u=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
<\/script>\r
`,C=JSON.parse('{"title":"31. 限制地图移动和缩小","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/31.limitPan/index.md","filePath":"3.examples/31.limitPan/index.md","lastUpdated":1790261744000}'),y={name:"3.examples/31.limitPan/index.md"},x=Object.assign(y,{setup(b){const a=t(!0);return(v,s)=>{const r=l("ClientOnly");return h(),p("div",null,[s[1]||(s[1]=e("h1",{id:"_31-限制地图移动和缩小",tabindex:"-1"},[d("31. 限制地图移动和缩小 "),e("a",{class:"header-anchor",href:"#_31-限制地图移动和缩小","aria-label":'Permalink to "31. 限制地图移动和缩小"'},"​")],-1)),o(n(i(g),null,null,512),[[c,a.value]]),n(r,null,{default:E(()=>[n(i(m),{title:"Example",description:"地图只能在设定范围移动",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:i(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=k(`<p>默认情况，地图是可以随意拖动的，但在一些场景中，我们希望限制地图只能在某个区域内移动，以防止地图拖的找不到了，这对显示小范围地图比较有用。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 限制地图移动范围</span></span>
