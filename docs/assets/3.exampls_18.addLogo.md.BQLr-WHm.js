import{p as l,C as r,c as p,o,j as e,a4 as h,G as n,a2 as k,a as c,a5 as d,k as i,w as g}from"./chunks/framework.CJqd0DOR.js";import{R as E,k as m}from"./chunks/index.Ga076E9x.js";const u=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,C=JSON.parse('{"title":"添加水印","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/18.addLogo.md","filePath":"3.exampls/18.addLogo.md","lastUpdated":1761368239000}'),y={name:"3.exampls/18.addLogo.md"},f=Object.assign(y,{setup(b){const a=l(!0);return(v,s)=>{const t=r("ClientOnly");return o(),p("div",null,[s[1]||(s[1]=e("h1",{id:"添加水印",tabindex:"-1"},[c("添加水印 "),e("a",{class:"header-anchor",href:"#添加水印","aria-label":'Permalink to "添加水印"'},"​")],-1)),h(n(i(E),null,null,512),[[d,a.value]]),n(t,null,{default:g(()=>[n(i(m),{title:"example",description:"添加水印logo",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{a.value=!1}),htmlCode:i(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=k(`<p>给地图添加水印，使用 logo 加载器插件完成。</p><h2 id="使用步骤" tabindex="-1">使用步骤： <a class="header-anchor" href="#使用步骤" aria-label="Permalink to &quot;使用步骤：&quot;">​</a></h2><ol><li>注册 logo 加载器插件。</li><li>定义 logo 数据源。</li><li>地图的影像数据使用 logo 数据源。</li></ol><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 注册logo加载器</span></span>
