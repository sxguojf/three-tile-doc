import{p as d,C as o,c as p,o as c,j as s,a4 as m,G as n,a2 as h,a as i,a5 as u,k as r,w as g}from"./chunks/framework.xbTv8SNN.js";import{R as v,k as w}from"./chunks/index.T3-yMMRo.js";const b=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
...
`,k={id:"_25-控制器切换",tabindex:"-1"},C=JSON.parse('{"title":"25. 控制器切换","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/25.changeControls/index.md","filePath":"3.exampls/25.changeControls/index.md","lastUpdated":1761902788000}'),y={name:"3.exampls/25.changeControls/index.md"},_=Object.assign(y,{setup(T){const t=d(!0);return(x,e)=>{const a=o("Badge"),l=o("ClientOnly");return c(),p("div",null,[s("h1",k,[e[1]||(e[1]=i("25. 控制器切换")),n(a,{type:"tip",text:"≥0.11.4"}),e[2]||(e[2]=i()),e[3]||(e[3]=s("a",{class:"header-anchor",href:"#_25-控制器切换","aria-label":'Permalink to "25. 控制器切换<Badge type="tip" text="≥0.11.4" />"'},"​",-1))]),m(n(r(v),null,null,512),[[u,t.value]]),n(l,null,{default:g(()=>[n(r(w),{title:"example",description:"切换地图控制器和轨道控制器",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:e[0]||(e[0]=()=>{t.value=!1}),htmlCode:r(b)},null,8,["htmlCode"])]),_:1}),e[4]||(e[4]=h('<p>V0.11.4 版本 <code>GLViewer</code> 增加 <code>controlsMode</code> 属性，用于切换 MAP 控制器和 ORBIT 控制器。</p><p>这没啥说的，修改 GLViewer.controlsMode 属性即可完成切换。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">GLViewer.controlsMode </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;MAP&quot;</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> |</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;ORBIT&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br></div></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>修改 Viewer.controls.zoomToCursor 属性， 能在地图在缩放时，选择以地图中心点为中心缩放，还是以鼠标位置为中心缩放。</p><p><a href="https://threejs.org/docs/#examples/zh/controls/OrbitControls.zoomToCursor" target="_blank" rel="noreferrer">https://threejs.org/docs/#examples/zh/controls/OrbitControls.zoomToCursor</a></p></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>V0.11.4 还增加了使用<code>PointerLockControls</code>控制器的 <code>PLViewer</code> 和 <code>FlyControls</code> 控制器 <code>FLViewer</code>。</p></div>',5))])}}});export{C as __pageData,_ as default};
