const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/Contour.BsdmOVWN.js","assets/chunks/framework.BQo5SrHh.js","assets/chunks/index.B0Mz6VAy.js","assets/chunks/style.B3RjSc2H.js","assets/chunks/useSky.ByY0yeG8.js","assets/chunks/useFog.nsXJc4ko.js"])))=>i.map(i=>d[i]);
import{p as s,D as d,v as u,V as p,C as m,c as v,o as b,j as i,a4 as f,G as n,a as w,a5 as g,k as r,w as c,a6 as h}from"./chunks/framework.BQo5SrHh.js";import{R as x,k as L}from"./chunks/index.UKPBqX0I.js";const S=`<template>\r
...
\r
            ...
            <label for="fogFactor"\r
                >雾浓度: <input type="range" id="fogFactor" min="0" max="5" step="0.1" v-model="fogFactor"\r
            /></label>\r
        </div>\r
...
`,R=JSON.parse('{"title":"5. 等高线","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/05.contour/index.md","filePath":"4.application/05.contour/index.md","lastUpdated":1761902788000}'),k={name:"4.application/05.contour/index.md"},D=Object.assign(k,{setup(C){const o=s(!0),t=d();return u(async()=>{t.value=(await p(async()=>{const{default:a}=await import("./chunks/Contour.BsdmOVWN.js");return{default:a}},__vite__mapDeps([0,1,2,3,4,5]))).default}),(a,e)=>{const l=m("ClientOnly");return b(),v("div",null,[e[1]||(e[1]=i("h1",{id:"_5-等高线",tabindex:"-1"},[w("5. 等高线 "),i("a",{class:"header-anchor",href:"#_5-等高线","aria-label":'Permalink to "5. 等高线"'},"​")],-1)),f(n(r(x),null,null,512),[[g,o.value]]),n(l,null,{default:c(()=>[n(r(L),{title:"vue演示",description:"地形等高线，地面单击标高，标牌单击删除",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:e[0]||(e[0]=()=>{o.value=!1}),vueCode:r(S)},h({_:2},[t.value?{name:"vue",fn:c(()=>[n(r(t))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{R as __pageData,D as default};
