const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/FlyControls.tSy-9_Nm.js","assets/chunks/index.D-Y8yZZR.js","assets/chunks/useSky.D-YiwE1J.js","assets/chunks/useState.BDVbIXbi.js","assets/chunks/framework.CJqd0DOR.js","assets/chunks/GLTFLoader.CkiCWgjt.js","assets/chunks/tween.module.BLfFZSQj.js"])))=>i.map(i=>d[i]);
import{p as h,D as k,v as o,V as d,C as c,c as E,o as y,j as t,a4 as g,G as i,a2 as u,a as F,a5 as b,k as n,w as r,a6 as m}from"./chunks/framework.CJqd0DOR.js";import{R as v,k as A}from"./chunks/index.Ga076E9x.js";const f=`<script setup lang="ts">\r
...
\r
    // 加载音效\r
    const audio = new Audio("./plane.mp3");\r
    audio.loop = true;\r
    // 音效控制\r
...
`,B=JSON.parse('{"title":"第三人称飞行","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/02.flyControls/index.md","filePath":"4.application/02.flyControls/index.md","lastUpdated":1761583418000}'),D={name:"4.application/02.flyControls/index.md"},_=Object.assign(D,{setup(C){const e=h(!0),a=k();return o(async()=>{a.value=(await d(async()=>{const{default:l}=await import("./chunks/FlyControls.tSy-9_Nm.js");return{default:l}},__vite__mapDeps([0,1,2,3,4,5,6]))).default}),(l,s)=>{const p=c("ClientOnly");return y(),E("div",null,[s[1]||(s[1]=t("h1",{id:"第三人称飞行",tabindex:"-1"},[F("第三人称飞行 "),t("a",{class:"header-anchor",href:"#第三人称飞行","aria-label":'Permalink to "第三人称飞行"'},"​")],-1)),g(i(n(v),null,null,512),[[b,e.value]]),i(p,null,{default:r(()=>[i(n(A),{title:"vue演示",description:"按任意键开始，WASD 键控制水平移动，RF 键控制升降，上下左右键控制转向，或用鼠标引导飞行方向",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{e.value=!1}),vueCode:n(f)},m({_:2},[a.value?{name:"vue",fn:r(()=>[i(n(a))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),s[2]||(s[2]=u(`<p><code>threejs</code> 提供了 <code>FlyControls</code> 控制器，能够真实模拟飞行场景，但官方示例 ( <a href="https://threejs.org/examples/?q=fly#misc_controls_fly" target="_blank" rel="noreferrer">https://threejs.org/examples/?q=fly#misc_controls_fly</a> ) 根本看不懂控制器在干啥，感觉完全失控了。其实 <code>FlyControls</code> 是一个非常好的控制器，可用于飞行游戏，用键盘或鼠标控制飞机，像飞机一样翻滚，只是作者没有写出好的示例，未能体现出它的价值。</p><p>将场景控制器更换为 <code>FlyControls</code>，添加一个飞机模型，仅需数十行代码即可完成一个第三人称飞行游戏。</p><h2 id="_1-更换控制器" tabindex="-1">1. 更换控制器 <a class="header-anchor" href="#_1-更换控制器" aria-label="Permalink to &quot;1. 更换控制器&quot;">​</a></h2><p><code>three-tile</code> 的地图模型不依赖特定 <code>controls</code>，所以可以更换任意控制器，跟上个示例第一人称射击一样，将控制器更换为 <code>FlyControls</code> ( <a href="https://threejs.org/docs/?q=fly#examples/zh/controls/FlyControls" target="_blank" rel="noreferrer">https://threejs.org/docs/?q=fly#examples/zh/controls/FlyControls</a>)</p><h2 id="_2-飞行" tabindex="-1">2. 飞行 <a class="header-anchor" href="#_2-飞行" aria-label="Permalink to &quot;2. 飞行&quot;">​</a></h2><p>加载一个模型，如小鸟、飞机，固定在摄像机前面，<code>FlyControls</code> 会自动完成飞行控制功能。</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
