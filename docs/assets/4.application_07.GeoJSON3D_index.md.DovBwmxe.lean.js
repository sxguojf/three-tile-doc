const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/GeoJSON3D.4tVXYsmz.js","assets/chunks/index.D1y5qgwe.js","assets/chunks/lil-gui.module.min.Vka56b52.js","assets/chunks/style.pzVcPuTj.js","assets/chunks/framework.xbTv8SNN.js","assets/chunks/useState.EiXjSKHF.js","assets/chunks/useSky.CzLXMfkB.js","assets/chunks/BufferGeometryUtils.DcNFALRP.js"])))=>i.map(i=>d[i]);
import{p as c,D as d,v as m,V as u,C as p,c as g,o as f,j as i,a4 as b,G as n,a as v,a5 as h,k as r,w as s,a6 as w}from"./chunks/framework.xbTv8SNN.js";/* empty css                     */import{VitepressDemoPlaceholder as x,VitepressDemoBox as y}from"vitepress-demo-plugin";const M=`<template>\r
...
<script setup lang="ts">\r
    ...
    import { GLTFExporter } from "three/examples/jsm/exporters/GLTFExporter.js";\r
    import { TransformControls } from "three/examples/jsm/controls/TransformControls.js";\r
...
\r
    // 围栏控制器（通过 GUI 切换平移/缩放模式）\r
    let fenceTransform: TransformControls | null = null;\r
\r
    // 添加围栏\r
    const addFence = (bbox: [number, number, number, number]) => {\r
        ...
        const fence = new Mesh(fenceGeometry, fenceMaterial);\r
        fence.name = "fence";\r
        fence.scale.set(box.max.x - box.min.x, box.max.y - box.min.y, box.max.z - box.min.z);\r
        box.getCenter(fence.position);\r
        map.add(fence);\r
\r
        fenceTransform = new TransformControls(viewer.camera, viewer.renderer.domElement);\r
        fenceTransform.showY = false;\r
        fenceTransform.attach(fence);\r
        const gizmo = fenceTransform.getHelper();\r
        gizmo.name = "transformGizmo";\r
        viewer.scene.add(gizmo);\r
        fenceTransform.addEventListener("dragging-changed", function (event) {\r
...
\r
        ...
        showFence: (value: boolean) => {\r
            const fenceMesh = map.getObjectByName("fence") as Mesh | undefined;\r
            if (fenceMesh) {\r
                fenceMesh.visible = value;\r
            }\r
            const gizmo = viewer.scene.getObjectByName("transformGizmo");\r
            if (gizmo) {\r
                gizmo.visible = value;\r
            }\r
        },\r
    };\r
\r
...
\r
        if (fenceTransform) {\r
            gui.add(fenceTransform, "mode", ["translate", "scale"]).name("围栏操作模式");\r
        }\r
\r
        gui.add(vm, "exportBuilding").name("导出建筑模型");\r
    };\r
<\/script>\r
`,B=JSON.parse('{"title":"7. 三维建筑物","description":"","frontmatter":{},"headers":[],"relativePath":"4.application/07.GeoJSON3D/index.md","filePath":"4.application/07.GeoJSON3D/index.md","lastUpdated":1790256523000}'),T={name:"4.application/07.GeoJSON3D/index.md"},C=Object.assign(T,{setup(L){const o=c(!0),t=d();return m(async()=>{t.value=(await u(async()=>{const{default:a}=await import("./chunks/GeoJSON3D.4tVXYsmz.js");return{default:a}},__vite__mapDeps([0,1,2,3,4,5,6,7]))).default}),(a,e)=>{const l=p("ClientOnly");return f(),g("div",null,[e[1]||(e[1]=i("h1",{id:"_7-三维建筑物",tabindex:"-1"},[v("7. 三维建筑物 "),i("a",{class:"header-anchor",href:"#_7-三维建筑物","aria-label":'Permalink to "7. 三维建筑物"'},"​")],-1)),b(n(r(x),null,null,512),[[h,o.value]]),n(l,null,{default:s(()=>[n(r(y),{title:"vue演示",description:"加载 GeoJSON 建筑数据（数据来源于 https://tubvsig-so2sat-vm1.srv.mwn.de/ 提供的WFS服务，已导出为本地文件），生成建筑物三维模型",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:e[0]||(e[0]=()=>{o.value=!1}),vueCode:r(M)},w({_:2},[t.value?{name:"vue",fn:s(()=>[n(r(t))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{B as __pageData,C as default};
