import{p as t,C as l,c as p,o as h,j as r,a4 as d,G as e,a2 as k,a as o,a5 as E,k as i,w as c}from"./chunks/framework.xbTv8SNN.js";import{R as g,k as m}from"./chunks/index.T3-yMMRo.js";const u=`<!DOCTYPE html>\r
<html lang="zh-cn">\r
    <head>\r
        ...
        <script type="importmap">\r
            {\r
                "imports": {\r
                    ...
                    "3DTilesRenderer": "https://cdn.jsdelivr.net/npm/3d-tiles-renderer@0.4.17/+esm"\r
                }\r
            }\r
        <\/script>\r
\r
...
\r
            ...
            viewer.flyTo(center, new THREE.Vector3(center.x, 20000, center.z - 30000), false);\r
            //==============================================================\r
\r
            // 3dtiles 辅助框\r
...
\r
            ...
            const load3dtiles = async (url) => {\r
                ...
                tilesRenderer.addEventListener("load-tile-set", () => {\r
                    ...
                    tilesRenderer.group.position.copy(sphere.center).multiplyScalar(-1);\r
                });\r
...
`,w=JSON.parse('{"title":"35. 使用 3DTilesRendererJS 加载 3DTiles","description":"","frontmatter":{},"headers":[],"relativePath":"3.exampls/35.3dtilesRender/index.md","filePath":"3.exampls/35.3dtilesRender/index.md","lastUpdated":1762073091000}'),y={name:"3.exampls/35.3dtilesRender/index.md"},T=Object.assign(y,{setup(b){const n=t(!0);return(v,s)=>{const a=l("ClientOnly");return h(),p("div",null,[s[1]||(s[1]=r("h1",{id:"_35-使用-3dtilesrendererjs-加载-3dtiles",tabindex:"-1"},[o("35. 使用 3DTilesRendererJS 加载 3DTiles "),r("a",{class:"header-anchor",href:"#_35-使用-3dtilesrendererjs-加载-3dtiles","aria-label":'Permalink to "35. 使用 3DTilesRendererJS 加载 3DTiles"'},"​")],-1)),d(e(i(g),null,null,512),[[E,n.value]]),e(a,null,{default:c(()=>[e(i(m),{title:"example",description:"地面挖一个方形洞，或抠出一块地图",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:s[0]||(s[0]=()=>{n.value=!1}),htmlCode:i(u)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=k(`<p>使用 <code>3DTilesRendererJS</code>(<a href="https://github.com/NASA-AMMOS/3DTilesRendererJS" target="_blank" rel="noreferrer">https://github.com/NASA-AMMOS/3DTilesRendererJS</a>) 加载 3dtiles 模型。</p><p>把 <code>3DTilesRendererJS</code> 的 <code>Basic TilesRenderer</code> 示例复制过来：</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 加载3dtiles</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br></div></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>由于 three-tile 使用 EPSG:3857 投影，而常见的 3dtiles 使用 EPSG:4326 投影，叠加时 3dtiles 很难和地图套准，只能手工调整 3dtiles 的位置和缩放尽量减小误差。</p></div>`,4))])}}});export{w as __pageData,T as default};
