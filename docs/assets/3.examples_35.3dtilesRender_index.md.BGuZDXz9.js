import{p as t,C as l,c as p,o as h,j as r,a4 as d,G as e,a2 as k,a as o,a5 as E,k as i,w as c}from"./chunks/framework.xbTv8SNN.js";import{I as g,$ as u}from"./chunks/index.Dw17pxVn.js";const m=`<style>\r
    html,\r
    body {\r
        color: white;\r
...
\r
    const url = "https://nasa-ammos.github.io/3DTilesRendererJS/data/tileset.json";\r
    const tilesRenderer = await load3dtiles(url);\r
    helper.add(tilesRenderer.group);\r
    viewer.addEventListener("update", (evt) => {\r
        tilesRenderer.update();\r
    });\r
<\/script>\r
`,R=JSON.parse('{"title":"35. 使用 3DTilesRendererJS 加载 3DTiles","description":"","frontmatter":{},"headers":[],"relativePath":"3.examples/35.3dtilesRender/index.md","filePath":"3.examples/35.3dtilesRender/index.md","lastUpdated":1775486036000}'),y={name:"3.examples/35.3dtilesRender/index.md"},T=Object.assign(y,{setup(b){const n=t(!0);return(F,s)=>{const a=l("ClientOnly");return h(),p("div",null,[s[1]||(s[1]=r("h1",{id:"_35-使用-3dtilesrendererjs-加载-3dtiles",tabindex:"-1"},[o("35. 使用 3DTilesRendererJS 加载 3DTiles "),r("a",{class:"header-anchor",href:"#_35-使用-3dtilesrendererjs-加载-3dtiles","aria-label":'Permalink to "35. 使用 3DTilesRendererJS 加载 3DTiles"'},"​")],-1)),d(e(i(g),null,null,512),[[E,n.value]]),e(a,null,{default:c(()=>[e(i(u),{title:"example",description:"加载 3DTiles",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Atrue%7D",codesandbox:"%7B%22show%22%3Atrue%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:s[0]||(s[0]=()=>{n.value=!1}),htmlCode:i(m)},null,8,["htmlCode"])]),_:1}),s[2]||(s[2]=k(`<p>使用 <code>3DTilesRendererJS</code>(<a href="https://github.com/NASA-AMMOS/3DTilesRendererJS" target="_blank" rel="noreferrer">https://github.com/NASA-AMMOS/3DTilesRendererJS</a>) 加载 3dtiles 模型。</p><p>把 <code>3DTilesRendererJS</code> 的 <code>Basic TilesRenderer</code> 示例复制过来：</p><div class="language-ts vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 加载3dtiles</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> url</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;https://nasa-ammos.github.io/3DTilesRendererJS/data/tileset.json&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> tilesRenderer</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> await</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> load3dtiles</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(url);</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">});</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br></div></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>由于 three-tile 使用 EPSG:3857 投影，而常见的 3dtiles 使用 EPSG:4326 投影，叠加时 3dtiles 很难和地图套准，只能手工调整 3dtiles 的位置和缩放尽量减小误差。</p></div>`,4))])}}});export{R as __pageData,T as default};
