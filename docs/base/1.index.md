...
与其它三维地图框架不同，three-tile并不提供完整的WebGIS功能，它仅提供一个地图三维模型（Mesh）。这样做的好处是它可以更加灵活，如果你的应用基于threejs开发，那很容易将地图作为一个模型加进去；另一方面，能保证框架的小巧，其它功能可通过插件扩充。使用three-tile开发，你需要了解一些threejs的基础知识。
